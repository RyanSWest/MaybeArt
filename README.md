...
- A crudstuff Greeter Solana program written in Anchor
...
```shell
pnpm create solana-dapp@latest -t gh:solana-foundation/templates/gill/crud-stuff
```
...
the constant in the `anchor/src/crudstuff-exports.ts` file.
